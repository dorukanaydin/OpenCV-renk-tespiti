...
#Webcam görüntüsündeki 4 rengi(mavi,yeşil,kırmızı,sarı) dikdörtgen içine alıp rengin ismini yazan program 
...
#Kırmızı 
	...
	for i,c in enumerate(cntr):
		...
		cv2.putText(frame,"Kirmizi",(x,y-10),cv2.FONT_HERSHEY_SIMPLEX, 1, (0,0,255), 2)
#Yeşil 
	...
	for i,c in enumerate(cntr):
		...
		cv2.putText(frame,"Yesil",(x,y-10),cv2.FONT_HERSHEY_SIMPLEX, 1, (0,255,0), 2)
#Mavi 
	...
	for i,c in enumerate(cntr):
		...
		cv2.putText(frame,"Mavi",(x,y-10),cv2.FONT_HERSHEY_SIMPLEX, 1, (255,0,0), 2)
#Sarı 
	...
	for i,c in enumerate(cntr):
		...
		cv2.putText(frame,"Sari",(x,y-10),cv2.FONT_HERSHEY_SIMPLEX, 1, (0,255,255), 2)
